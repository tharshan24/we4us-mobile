      ...
      <View style={styles.mainContainer}>
        <View style={styles.headingContainer}>
          <View style={styles.txtCon}>
            <Text style={styles.headingTxt}>{'Care Home \n100th Anniversary'}</Text>
          </View>
          <View style={styles.iconCon}>
            ...
            <TouchableOpacity
              activeOpacity={0.7}
              onPress={() => navigation.navigate('RequestForDonationHome')}>
              <MaterialCommunityIcons
                name="account-group"
                color="#ffffff"
                size={30}
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.txtContainer}>
            ...
            <View style={{flex: 1}}>
              <Text style={styles.resultsTxt}>{'Nagai Luxury elder \ncare'}</Text>
            </View>
          </View>
          {/*txt3*/}
          ...
          <View style={styles.txtContainer}>
            ...
            <View style={{flex: 1}}>
              <Text style={styles.resultsTxt}>100th Anniversary</Text>
            </View>
          </View>
          {/*txt9*/}
          <View style={styles.txtContainer}>
