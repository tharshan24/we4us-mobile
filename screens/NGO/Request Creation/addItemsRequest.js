...
const AddItemsRequestNgo = ({navigation}) => {
  ...
  const requestItems = async (value) => {
    try {
      ...
      await AsyncStorage.setItem('@requestedItemsNgo', jsonValue);
    } catch (e) {
      console.log(e);
    }
  };
  ...
  const removeValue = async () => {
    try {
      await AsyncStorage.removeItem('@requestedItemsNgo');
      console.log('success');
    } catch (e) {
      console.log(e);
    }
...
export default AddItemsRequestNgo;
