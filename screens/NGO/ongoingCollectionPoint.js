...
function OngoingCollectionpointNgo(props) {
  ...
  const getRequests = async () => {
    try {
      await axios
        .get(constants.BASE_URL + 'org/getMyCollectionPoints', {
          headers: {
              ...
              <View style={styles.AvailabilityCon}>
                ...
                <View>
                  ...
                  <Text style={styles.bodyText}>
                    Type:{values.assigned_to}
                  </Text>
                  <Text style={styles.bodyText}>
                    Best Before:{values.start_time.split('T')[0]}
                  </Text>
                </View>
              </View>
            </TouchableOpacity>
...
export default OngoingCollectionpointNgo;
